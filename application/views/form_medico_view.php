      ...
      <div class="container-fluid">
        ...
        <form>
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              <!-- Custom tabs (Charts with tabs)-->
              <button type="button" class="btn btn-primary pull-right" onclick="add_medico()">Registrar Nuevo</button>
              <!-- /.card -->
            </section>
            <section class="col-lg-12 connectedSortable">
              <!-- Custom tabs (Charts with tabs)-->
        ...
        <form id="form">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="txtdni" name="txtdni" maxlength="8" size="8" placeholder="Ejem: 0000000">
