...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/plugins/timepicker/bootstrap-datetimepicker.min.css">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url(); ?>login/logout" class="dropdown-item dropdown-footer">Cerrar Sesión</a>
        </div>
      </li>
    </ul>
  </nav>
