      ...
      <div class="container-fluid">
        ...
        <form id="formcitas">
          <div class="row">
            ...
            <section class="col-lg-2 " align="center">
              <!-- Custom tabs (Charts with tabs)-->
              <div class="card">
              ...
              <div class="card" >
                <div class="card-body ">
                  <div class="row form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" class="form-control" <?php if($paciente_id!=''){ echo 'readonly=""';} ?> name="dni" id="dni" maxlength="8" size="8" value="<?php echo $dni; ?>">
            ...
            <section class="col-lg-12 ">
              ...
              <div class="card" >
                <div class="card-body ">
                  <div class="row form-group">
                    <div class="col-md-2">
                      <label for="">Seleccionar horario:</label>
                    </div>
                    <div class="col-md-5">
            ...
            <section class="col-lg-12 ">
              ...
              <div class="card" >
                <div class="card-body ">
                  <div class="row form-group">
                    <button type="button" class="btn btn-success" id="btnSave2" onclick="saveCita()">Registrar</button>
            ...
            <section class="col-lg-12 ">
              ...
              <div class="card" >
                ...
                <div class="card-body ">
                  <table class="table table-striped" id="cita_table">
                    <thead>
                      <tr>
                        <th>Fecha</th>
                        <th>Hora</th>
